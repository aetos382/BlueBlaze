...
#pragma warning restore CA1304
    ...
    internal static string FormatRunAsBuildTaskInvalidValue(string? value) =>
        string.Format(CultureInfo.InvariantCulture, RunAsBuildTaskInvalidValue, value);

    internal static string FormatIsLexiconDocumentNotSet(string path) =>
        string.Format(CultureInfo.InvariantCulture, IsLexiconDocumentNotSet, path);

    internal static string FormatIsLexiconDocumentInvalidValue(string? value, string path) =>
        string.Format(CultureInfo.InvariantCulture, IsLexiconDocumentInvalidValue, value, path);

    internal static string FormatCouldNotReadFile(string path) =>
        string.Format(CultureInfo.InvariantCulture, CouldNotReadFile, path);
}
